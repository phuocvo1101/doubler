...
use Controllers\ProductZanoxController;
use Controllers\ProgramZanoxController;
        ...
        if (isset($_GET["controller"]) && isset($_GET['action'])) {
            ...
            switch (strtolower($_GET["controller"])) {
                ...
                case "product":
                    ...
                    break;
                case "productzanox":
                    $this->baseController = new ProductZanoxController();
                    break;
                case "program":
                    $this->baseController = new ProgramController();
                    break;
                case "programzanox":
                    $this->baseController = new ProgramZanoxController();
                    break;
                case "dashboard":
