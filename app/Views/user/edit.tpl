...
<form id="frm" action="index.php?controller=user&action=edit" method="post">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div class=" form">
                                <form class="cmxform form-horizontal tasi-form" id="settingForm" method="post" action="index.php?controller=user&action=edit" novalidate="novalidate">
                                    ...
                                    <div class="form-group">
                                        <div class="col-lg-offset-2 col-lg-10">
                                            ...
                                            <button class="btn btn-default" onclick="window.location='index.php?controller=user&action=index'" type="button">Back</button>
